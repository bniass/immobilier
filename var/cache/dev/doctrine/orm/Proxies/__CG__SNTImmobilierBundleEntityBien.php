...
namespace Proxies\__CG__\SNT\ImmobilierBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Bien extends \SNT\ImmobilierBundle\Entity\Bien implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SNT\\ImmobilierBundle\\Entity\\Bien' . "\0" . 'id', '' . "\0" . 'SNT\\ImmobilierBundle\\Entity\\Bien' . "\0" . 'nomBien', '' . "\0" . 'SNT\\ImmobilierBundle\\Entity\\Bien' . "\0" . 'etat', '' . "\0" . 'SNT\\ImmobilierBundle\\Entity\\Bien' . "\0" . 'descrition', '' . "\0" . 'SNT\\ImmobilierBundle\\Entity\\Bien' . "\0" . 'prixLocation', '' . "\0" . 'SNT\\ImmobilierBundle\\Entity\\Bien' . "\0" . 'bienParent', '' . "\0" . 'SNT\\ImmobilierBundle\\Entity\\Bien' . "\0" . 'localite', '' . "\0" . 'SNT\\ImmobilierBundle\\Entity\\Bien' . "\0" . 'typeBien', '' . "\0" . 'SNT\\ImmobilierBundle\\Entity\\Bien' . "\0" . 'images'];
        }
